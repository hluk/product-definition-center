...
class ComponentBranchFilter(django_filters.FilterSet):
    ...
    global_component = django_filters.CharFilter(
        field_name='global_component__name', lookup_expr='exact')
    type = django_filters.CharFilter(
        field_name='type__name', lookup_expr='exact')
...
class SLAToComponentBranchFilter(django_filters.FilterSet):
    sla = django_filters.CharFilter(field_name='sla__name', lookup_expr='exact')
    branch = django_filters.CharFilter(field_name='branch__name', lookup_expr='exact')
    global_component = django_filters.CharFilter(field_name='branch__global_component__name', lookup_expr='exact')
    branch_type = django_filters.CharFilter(field_name='branch__type__name', lookup_expr='exact')
    branch_active = CaseInsensitiveBooleanFilter(field_name='branch__active', method=filter_active_sla_to_branch)
    branch_critical_path = CaseInsensitiveBooleanFilter(field_name='branch__critical_path', lookup_expr='iexact')
    eol_after = django_filters.DateFilter(field_name="eol", lookup_expr='gte')
    eol_before = django_filters.DateFilter(field_name="eol", lookup_expr='lte')
